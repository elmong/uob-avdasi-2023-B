...
button_1 = Button(865 - 208 * 1, 0, 1920-865*2, 64, colours['pearl'], fonts['dbxl_title'], "FORCE RFSH", callback = lambda: ui_commands.update(force_refresh=1))
button_4 = Button(865, 0, 1920-865*2, 64, colours['pearl'], fonts['dbxl_title'], "GRAPH DSP", callback = lambda: ui_commands.update(csv_plot=1))
pico_com_refresh_button = Button(865 + 208 * 1, 0, 1920-865*2, 64, colours['pearl'], fonts['dbxl_title'], "PICO RFSH", callback = lambda: ui_commands.update(pico_refresh_com=1))
